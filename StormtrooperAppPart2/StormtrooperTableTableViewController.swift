//
//  StormtrooperTableTableViewController.swift
...
class StormtrooperTableTableViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?){
        if segue.identifier == "ShowTrooper"{
            let trooperVC = segue.destination as? StormtrooperViewController
